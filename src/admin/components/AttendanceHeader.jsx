...
export default function AttendanceHeader({ onMark }) {
      ...
      <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-4 max-w-2xl leading-7 text-slate-400">
            Track employee attendance, monitor working hours, manage shifts and
            generate attendance reports from one centralized dashboard.
          </p>
