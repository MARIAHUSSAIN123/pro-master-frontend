...
export default function InventoryHeader({ onAdd, lowStockCount = 0 }) {
  return (
    <motion.div
      ...
      <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-4 max-w-2xl leading-7 text-slate-400">
            Track supplies, machinery, vehicles and PPE — stock levels,
            assignments to staff, and preventive maintenance.
          </p>

          {lowStockCount > 0 && (
            <div className="mt-5 inline-flex items-center gap-2 rounded-2xl border border-red-500/30 bg-red-500/10 px-5 py-3 text-red-300">
