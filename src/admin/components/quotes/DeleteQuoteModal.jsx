...
export default function DeleteQuoteModal({ open, onClose, onDelete, quoteLabel = "this quote", deleting, error }) {
  if (!open) return null;
      ...
      >
        ...
        >
          ...
          <div className="p-10">
            ...
            <h2 className="mt-8 text-center text-3xl font-bold text-white">Delete Quote?</h2>
            <p className="mt-5 text-center leading-7 text-slate-400">
              You are about to permanently remove
              <span className="font-semibold text-white"> {quoteLabel} </span>
              from the system.
            </p>
            ...
            <div className="mt-10 flex gap-4">
              ...
              <button
                onClick={onDelete}
                disabled={deleting}
                className="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-red-500 to-red-700 py-4 font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-500/30 disabled:opacity-60 disabled:hover:scale-100"
              >
                <Trash2 size={20} />
